...
In contrast to the plain "build_id" test, build_id_module_override checks that
modules that explicitly set -fuse-ld in LOCAL_LDFLAGS will have that choice
honored even if it conflicts with APP_LD.
"""
